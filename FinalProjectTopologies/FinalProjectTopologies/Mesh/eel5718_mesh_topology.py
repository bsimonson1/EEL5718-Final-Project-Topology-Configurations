...
def myNetwork():
    ...
    s1s3 = {'bw':100,'delay':'25ms','loss':1,'max_queue_size':50}
    net.addLink(s1, s3, cls=TCLink , **s1s3)
    s3s5 = {'bw':100,'delay':'25ms','loss':1,'max_queue_size':50}
    net.addLink(s3, s5, cls=TCLink , **s3s5)
    s4s2 = {'bw':100,'delay':'25ms','loss':1,'max_queue_size':50}
    net.addLink(s4, s2, cls=TCLink , **s4s2)
    s5s2 = {'bw':100,'delay':'25ms','loss':1,'max_queue_size':50}
    net.addLink(s5, s2, cls=TCLink , **s5s2)
    s1s4 = {'bw':100,'delay':'25ms','loss':1,'max_queue_size':50}
