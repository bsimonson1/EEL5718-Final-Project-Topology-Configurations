...
def myNetwork():
    ...
    s1h3 = {'bw':100,'delay':'25ms','loss':1,'max_queue_size':50}
    ...
    h13s5 = {'bw':100,'delay':'25ms','loss':1,'max_queue_size':50}
    net.addLink(h13, s5, cls=TCLink , **h13s5)
    h14s5 = {'bw':100,'delay':'25ms','loss':1,'max_queue_size':50}
    net.addLink(h14, s5, cls=TCLink , **h14s5)
    h15s5 = {'bw':100,'delay':'25ms','loss':1,'max_queue_size':50}
    net.addLink(h15, s5, cls=TCLink , **h15s5)
    s5s4 = {'bw':100,'delay':'25ms','loss':1,'max_queue_size':50}
